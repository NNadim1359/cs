...
function fn_vendor_data_premoderation_clone_product_post(
    ...
    if (fn_vendor_data_premoderation_product_requires_approval(Registry::get('runtime.company_data'))) {
 ...
 */
function fn_vendor_data_premoderation_update_product_pre($product_data, $product_id)
{
    ...
    if (!isset($product_data['status']) || !$product_id || $runtime_company_id) {
        return;
    }
