...
function fn_calculate_commission_for_payout($order_info, $company_data, $payout_data)
{
    if (
        ...
        $percent_commission = (float) $formatter->asPrice($percent_commission, CART_PRIMARY_CURRENCY, false, false);
        ...
        $commission_amount = (float) $formatter->asPrice($commission_amount, CART_PRIMARY_CURRENCY, false, false);
